	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
			<div class="comment-header">
                ...
                <span class="comment-name"><b><?php comment_author_link() ?></b> zegt:</span>
                <small><?php comment_date('j F Y') ?><?php edit_comment_link('edit',' | <b>','</b>'); ?></small>
			</div>
			<?php if ($comment->comment_approved == '0') : ?>
			<i>Je reactie moet nog worden goedgekeurd</i>
			<?php endif; ?>
