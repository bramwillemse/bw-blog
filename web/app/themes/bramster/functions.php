...
/* 	============================================================================
	...
	if(function_exists('register_sidebar')) {
		...
		register_sidebar(array(
			...
			'id' => 'widgets-about',
			'class' => 'widgets-about',
			'before_widget' => '<aside class="l-column l-column-small widget widget-left">',
			'after_widget' => '</aside>',
			'before_title' => '<h2>',
			'after_title' => '</h2>',
		));
		...
		register_sidebar(array(
			...
			'before_widget' => '<aside class="l-column l-column-small widget widget-left nav nav-sidebar">',
			'after_widget' => '</aside>',
			'before_title' => '<h2>',
			'after_title' => '</h2>',
		));
